...
static int shp0(int x, int y, t_point p[], int pSize);

static int previousX;
static int previousY;
static int shp0Count = 0;


typedef int (*inShapePtr)(int, int, int);
typedef int (*inShapePtr2)(int, int, t_point p[], int pSize);

inShapePtr inShapes[SHAPE_N] = {inCircle, inHexagon};
inShapePtr2 inShapes2 = shp0;
